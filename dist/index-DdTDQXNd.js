...
var Rn = { exports: {} }, Op = Rn.exports, $h;
function Lp() {
  return $h || ($h = 1, (function(Be, Xt) {
    /**
    ...
    */
    (function(dt, qt) {
      dt._Highcharts = qt(), Be.exports = dt._Highcharts;
    })(typeof window > "u" ? Op : window, () => (() => {
      let dt, qt;
      var ye, Qt, de, ne, te, Ne, Rs, zs, Fs, Mi, Ai, Ti, Si, Ci, Hs, _i, gt, Ji, Ei = {};
      Ei.d = (h, t) => {
      ...
      let X = ye, { charts: ae, doc: Qi, win: Re } = X;
      function ei(h, t, e, i) {
 ...
 - ${d}: ${l}`, r && (o += encodeURI(d) + "=" + encodeURI(l));
      ...
      let Gt = Array.prototype.find ? function(h, t) {
        return h.find(t);
      } : function(h, t) {
        let e, i = h.length;
      ...
      Re.jQuery && (Re.jQuery.fn.highcharts = function() {
        ...
        if (this[0]) return h[0] ? (new X[Ot(h[0]) ? h.shift() : "Chart"](this[0], h[0], h[1]), this) : ae[Gs(this[0], "data-highcharts-chart")];
      });
      let $ = { addEvent: function(h, t, e, i = {}) {
      ...
      }, find: Gt, fireEvent: ss, getAlignFactor: (h = "") => ({ center: 0.5, right: 1, middle: 0.5, bottom: 1 })[h] || 0, getClosestDistance: function(h, t) {
        let e, i, s, r = !t;
        return h.forEach((o) => {
      ...
      } }, { pageLang: Hn, win: rs } = X, { defined: ce, error: so, extend: ee, isNumber: ro, isObject: si, isString: Oi, merge: oo, objectEach: Wn, pad: ke, splat: Xn, timeUnits: Vs, ucfirst: Gn } = $, qs = X.isSafari && rs.Intl && !rs.Intl.DateTimeFormat.prototype.formatRange, Yn = (h) => h.main === void 0, jn = class {
        constructor(h, t) {
        ...
        dateFormat(h, t, e) {
          ...
          if (Oi(h) && h.indexOf("%") !== -1) {
            ...
            Wn(ee({ a: b ? b[f] : x[f].substr(0, 3), A: x[f], d: ke(n), e: ke(n, 2, " "), w: f, v: i?.weekFrom ?? "", b: k[o], B: M[o], m: ke(o + 1), o: o + 1, y: r.toString().substr(2, 2), Y: r, H: ke(l), k: l, I: ke(l % 12 || 12), l: l % 12 || 12, M: ke(d), p: l < 12 ? "AM" : "PM", P: l < 12 ? "am" : "pm", S: ke(m), L: ke(c, 3) }, X.dateFormats), function(v, S) {
            ...
            h = o + this.dateTimeFormat(ee({ timeZone: r }, h), t) + n;
          }
          return e ? Gn(h) : h;
        }
        resolveDTLFormat(h) {
      ...
      } }, { win: Vn } = X, { isNumber: Li, isString: qn, merge: os, pInt: Yt, defined: co } = $, po = (h, t, e) => `color-mix(in srgb,${h},${t} ${100 * e}%)`, ns = (h) => qn(h) && !!h && h !== "none";
      class bt {
        static parse(t) {
        ...
        brighten(t) {
          ...
          else if (Li(t) && t !== 0) if (Li(e[0])) for (let i = 0; i < 3; i++) e[i] += Yt(255 * t), e[i] < 0 && (e[i] = 0), e[i] > 255 && (e[i] = 255);
      ...
      bt.names = { white: "#ffffff", black: "#000000" }, bt.parsers = [{ regex: /rgba\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d?(?:\.\d+)?)\s*\)/, parse: function(h) {
        return [Yt(h[1]), Yt(h[2]), Yt(h[3]), parseFloat(h[4], 10)];
      } }, { regex: /rgb\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*\)/, parse: function(h) {
        return [Yt(h[1]), Yt(h[2]), Yt(h[3]), 1];
      } }, { regex: /^#([a-f0-9])([a-f0-9])([a-f0-9])([a-f0-9])?$/i, parse: function(h) {
        return [Yt(h[1] + h[1], 16), Yt(h[2] + h[2], 16), Yt(h[3] + h[3], 16), co(h[4]) ? Yt(h[4] + h[4], 16) / 255 : 1];
      } }, { regex: /^#([a-f0-9]{2})([a-f0-9]{2})([a-f0-9]{2})([a-f0-9]{2})?$/i, parse: function(h) {
        return [Yt(h[1], 16), Yt(h[2], 16), Yt(h[3], 16), co(h[4]) ? Yt(h[4], 16) / 255 : 1];
      ...
      class jt {
        ...
        run(t, e, i) {
          let s = this, r = s.options, o = function(d) {
            ...
            for (let d = 0; d < jt.timers.length; d++) jt.timers[d]() || jt.timers.splice(d--, 1);
            jt.timers.length && n(l);
          };
          t !== e || this.elem["forceAnimate:" + this.prop] ? (this.startTime = +/* @__PURE__ */ new Date(), this.start = t, this.end = e, this.unit = i, this.now = this.start, this.pos = 0, o.elem = this.elem, o.prop = this.prop, o() && jt.timers.push(o) === 1 && n(l)) : (delete r.curAnim[this.prop], r.complete && Object.keys(r.curAnim).length === 0 && r.complete.call(this.elem));
        }
        step(t) {
        ...
        fillSetter() {
          jt.prototype.strokeSetter.apply(this, arguments);
        }
        strokeSetter() {
      ...
      function hs(h, t) {
        let e = jt.timers.length;
        for (; e--; ) jt.timers[e].elem !== h || t && t !== jt.timers[e].prop || (jt.timers[e].stopped = !0);
      }
      let It = { animate: function(h, t, e) {
        ...
        _s(e) || (n = arguments, e = { duration: n[2], easing: n[3], complete: n[4] }), Zn(e.duration) || (e.duration = 400), e.easing = typeof e.easing == "function" ? e.easing : Math[e.easing] || Math.easeInOutSine, e.curAnim = xo(t), as(t, function(l, d) {
          hs(h, d), o = new jt(h, e, d), r = void 0, d === "d" && $n(t.d) ? (o.paths = o.initPath(h, h.pathArray, t.d), o.toD = t.d, i = 0, r = 1) : h.attr ? i = h.attr(d) : (i = parseFloat(fo(h, d)) || 0, d !== "opacity" && (s = "px")), r || (r = l), typeof r == "string" && r.match("px") && (r = r.replace(/px/g, "")), o.run(i, r, s);
        });
      ...
      let { defaultOptions: vo, defaultTime: wo } = Kt, { pageLang: ia } = X, { extend: sa, getNestedProperty: ko, isArray: ra, isNumber: Mo, isObject: sr, isString: rr, pick: or, ucfirst: Ao } = $, cs = { add: (h, t) => h + t, divide: (h, t) => t !== 0 ? h / t : "", eq: (h, t) => h == t, each: function(h) {
      ...
      let Ut = { dateFormat: function(h, t, e) {
      ...
      let Ii = Qt, { clamp: oa, pick: na, pushUnique: aa, stableSort: hr } = $;
      ...
      let le = Bt, { defined: Bo, extend: xa, getAlignFactor: No, isNumber: Ri, merge: gs, pick: zi, removeEvent: Fe } = $;
      class He extends le {
        ...
        destroy() {
          Fe(this.element, "mouseenter"), Fe(this.element, "mouseleave"), this.text && this.text.destroy(), this.box && (this.box = this.box.destroy()), le.prototype.destroy.call(this);
        }
        fillSetter(t, e) {
      ...
      }, { defaultOptions: ka } = Kt, { charts: yr, deg2rad: Xo, doc: _e, isFirefox: Rt, isMS: br, isWebKit: ms, noop: ai, SVG_NS: Ma, symbolSizes: Ge, win: vr } = X, { addEvent: fs, attr: li, createElement: Go, crisp: he, css: Se, defined: Nt, destroyObjectProperties: xs, extend: Ye, isArray: ys, isNumber: ue, isObject: Wi, isString: wr, merge: kr, pick: Mr, pInt: Aa, replaceNested: Ta, uniqueKey: Sa } = $;
      class bs {
        ...
        getReferenceURL() {
          if ((Rt || ms) && _e.getElementsByTagName("base").length) {
            if (!Nt(qt)) {
              ...
              Se(e, { position: "fixed", top: 0, left: 0, zIndex: 9e5 }), qt = _e.elementFromPoint(6, 6)?.id === "hitme", _e.body.removeChild(e);
            }
            if (qt) return Ta(vr.location.href.split("#")[0], [/<[^>]*>/g, ""], [/([\('\)])/g, "\\$1"], [/ /g, "%20"]);
          }
          return "";
        }
        getStyle(t) {
        ...
        crispLine(t, e) {
          let [i, s] = t;
          return Nt(i[1]) && i[1] === s[1] && (i[1] = s[1] = he(i[1], e)), Nt(i[2]) && i[2] === s[2] && (i[2] = s[2] = he(i[2], e)), t;
        }
        path(t) {
        ...
        fontMetrics(t) {
          let e = ue(t) ? t : Aa(le.prototype.getStyle.call(t, "font-size") || 0), i = e < 24 ? e + 3 : Math.round(1.2 * e), s = Math.round(0.8 * i);
          return { h: i, b: s, f: e };
        }
        rotCorr(t, e, i) {
          let s = t;
      ...
      Ye(bs.prototype, { Element: le, SVG_NS: Ma, escapes: { "&": "&amp;", "<": "&lt;", ">": "&gt;", "'": "&#39;", '"': "&quot;" }, symbols: We, draw: ai }), Ii.registerRendererType("svg", bs, !0);
      ...
      function Uo(h, t, e) {
        ...
        le.prototype[`${t}Setter`].call(this, h, t, e), i && (e.style[t] = i[t] = h);
      }
      let Vo = (h, t) => {
        if (!h.div) {
          ...
          h.classSetter = (r, o, n) => {
            ...
            return le.prototype.on.apply({ element: s, onEvents: h.onEvents }, arguments), h;
          }, h.div = s;
        }
        return h.div;
      };
      ...
      let qo = ne, { addEvent: Ko, isFunction: $o, objectEach: Zo, removeEvent: _o } = $;
      (te || (te = {})).registerEventOptions = function(h, t) {
      ...
      let hi = te, { deg2rad: Ar } = X, { clamp: Jo, correctFloat: Xi, defined: Tr, destroyObjectProperties: Ia, extend: Qo, fireEvent: Gi, getAlignFactor: Sr, isNumber: di, merge: Cr, objectEach: Er, pick: me } = $, ci = class {
        ...
        addLabel() {
          ...
          let O = (N) => l.formatter ? l.formatter.call(N, N) : l.format ? (N.text = t.defaultLabelFormatter.call(N), Ut.format(l.format, N, i)) : t.defaultLabelFormatter.call(N), L = O.call(C, C), D = k?.list;
      ...
      }, { animObject: tn } = It, { xAxis: en, yAxis: sn } = qo, { defaultOptions: Pr } = Kt, { registerEventOptions: Ba } = hi, { deg2rad: Na } = X, { arrayMax: rn, arrayMin: Ra, clamp: Or, correctFloat: Vt, defined: yt, destroyObjectProperties: on, erase: Lr, error: Dr, extend: pi, fireEvent: Tt, getClosestDistance: Yi, insertItem: nn, isArray: ks, isNumber: Q, isString: an, merge: Je, normalizeTickInterval: Ms, objectEach: As, pick: ot, relativeLength: Ts, removeEvent: za, splat: Fa, syncTimeout: Ha } = $, Ir = (h, t) => Ms(t, void 0, void 0, ot(h.options.allowDecimals, t < 0.5 || h.tickAmount !== void 0), !!h.tickAmount);
      ...
      class ui {
        ...
        translate(t, e, i, s, r, o) {
          ...
          return x || (x = n.transA), i && (c *= -1, f = n.len), n.reversed && (c *= -1, f -= c * (n.sector || n.len)), e ? (b = (t = t * c + f - d) / x + l, m && (b = n.lin2val(b))) : (m && (t = n.val2lin(t)), b = c * (t - l) * x + f + c * d + (Q(o) ? x * o : 0), n.isRadial || (b = Vt(b))), b;
        }
        toPixels(t, e) {
        ...
        getLinearTickPositions(t, e, i) {
          let s, r, o, n = Vt(Math.floor(e / t) * t), l = Vt(Math.ceil(i / t) * t), d = [];
          if (Vt(n + t) === n && (o = 20), this.single) return [e];
          for (s = n; s <= l && (d.push(s), (s = Vt(s + t, o)) !== r); ) r = s;
          return d;
        }
        ...
        adjustTickAmount() {
          let t = this, { finalTickAmt: e, max: i, min: s, options: r, tickPositions: o, tickAmount: n, thresholdAlignment: l } = t, d = o?.length, m = ot(t.threshold, t.softThreshold ? 0 : null), c, f, x = t.tickInterval, b, M = () => o.push(Vt(o[o.length - 1] + x)), k = () => o.unshift(Vt(o[0] - x));
        ...
        getExtremes() {
          ...
          return { min: t ? Vt(t.lin2log(this.min)) : this.min, max: t ? Vt(t.lin2log(this.max)) : this.max, dataMin: this.dataMin, dataMax: this.dataMax, userMin: this.userMin, userMax: this.userMax };
        }
        getThreshold(t) {
        ...
        unsquish() {
          let t = this.options.labels, e = t.padding || 0, i = this.horiz, s = this.tickInterval, r = this.len / ((+!!this.categories + this.max - this.min) / s), o = t.rotation, n = Vt(0.8 * this.labelMetrics().h), l = Math.max(this.max - this.min, 0), d = function(b) {
            let M = (b + 2 * e) / (r || 1);
            return (M = M > 1 ? Math.ceil(M) : 1) * s > l && b !== 1 / 0 && r !== 1 / 0 && l && (M = Math.ceil(l / s)), Vt(M * s);
      ...
      let { animObject: pn } = It, { format: un } = Ut, { composed: Ps, dateFormats: qa, doc: Hr, isSafari: Wr } = X, { distribute: Ka } = ps, { addEvent: $a, clamp: gi, css: Ue, discardElement: Za, extend: Xr, fireEvent: Os, getAlignFactor: gn, isArray: Gr, isNumber: mn, isObject: se, isString: Yr, merge: u, pick: a, pushUnique: p, splat: g, syncTimeout: y } = $;
      class A {
        constructor(t, e, i) {
        ...
        getPosition(t, e, i) {
          ...
          let Y = !this.followPointer && a(i.ttBelow, !c && !l === W), H = function(j, q, _, vt, ht, Zt, st) {
            ...
            if (Y && wt) b[j] = mt;
              ...
              b[j] = Math.max(Zt, mt + M + _ > q ? mt : mt + M);
            }
        ...
        renderSplit(t, e) {
          ...
          let q = t.slice(0, e.length + 1).reduce(function(st, it, ut) {
            if (it !== !1 && it !== "") {
              let at = e[ut - 1] || { isHeader: !0, plotX: e[0].plotX, plotY: n, series: {} }, wt = at.isHeader, kt = wt ? i : at.series, mt = kt.tt = (function(De, Jt, Ke) {
                let ki = De, { isHeader: Zi, series: eo } = Jt, Ie = eo.tooltipOptions || b;
                if (!ki) {
                  let Ns = { padding: Ie.padding, r: Ie.borderRadius };
                  f || (Ns.fill = Ie.backgroundColor, Ns["stroke-width"] = Ie.borderWidth ?? (M && !Zi ? 0 : 1)), ki = N.label("", 0, 0, Ie[Zi ? "headerShape" : "shape"] || (M && !Zi ? "rect" : "callout"), void 0, void 0, Ie.useHTML).addClass(i.getClassName(Jt, !0, Zi)).attr(Ns).add(D);
                }
                return ki.isActive = !0, ki.attr({ text: Ke }), f || ki.css(Ie.style).attr({ stroke: Ie.borderColor || Jt.color || eo.color || "#333333" }), ki;
              })(kt.tt, at, it.toString()), Pt = mt.getBBox(), _t = Pt.width + mt.strokeWidth();
              wt && (Z = Pt.height, J += Z, I && (V -= Z));
              let { anchorX: oe, anchorY: wi } = (function(De) {
                let Jt, Ke, { isHeader: ki, plotX: Zi = 0, plotY: eo = 0, series: Ie } = De;
                if (ki) Jt = Math.max(l + Zi, l), Ke = d + n / 2;
                else {
                  let { xAxis: Ns, yAxis: Kh } = Ie;
                  Jt = Ns.pos + gi(Zi, -x, Ns.len + x), Ie.shouldShowTooltip(0, Kh.pos - d + eo, { ignoreX: !0 }) && (Ke = Kh.pos + eo);
                }
                return { anchorX: Jt = gi(Jt, L.left - x, L.right + x), anchorY: Ke };
              })(at);
              if (typeof wi == "number") {
                let De = Pt.height + 1, Jt = (v || j).call(i, _t, De, at, [oe, wi]);
                st.push({ align: H ? 0 : void 0, anchorX: oe, anchorY: wi, boxWidth: _t, point: at, rank: a(Jt.rank, +!!wt), size: De, target: Jt.y, tt: mt, x: Jt.x });
              } else mt.isActive = !1;
            }
            return st;
          }, []);
          ...
          let { container: vt, outside: ht, renderer: Zt } = i;
          if (ht && vt && Zt) {
            let { width: st, height: it, x: ut, y: at } = D.getBBox();
            Zt.setSize(st + ut, it + at, !1), vt.style.left = _.left + "px", vt.style.top = Y + "px";
          }
      ...
      let w = A, { animObject: T } = It, { defaultOptions: E } = Kt, { format: P } = Ut, { addEvent: B, crisp: z, erase: R, extend: F, fireEvent: G, getNestedProperty: U, isArray: ct, isFunction: nt, isNumber: rt, isObject: lt, merge: tt, pick: et, syncTimeout: ft, removeEvent: xt, uniqueKey: zt } = $;
      class St {
      ...
      let Lt = St, { parse: Ee } = bt, { charts: Ls, composed: td, isTouchDevice: ed } = X, { addEvent: xe, attr: id, css: _a, extend: Ja, find: Rl, fireEvent: mi, isNumber: fn, isObject: xn, objectEach: sd, offset: rd, pick: Ve, pushUnique: od, splat: zl } = $;
      class Ht {
        ...
        destroy() {
          let t = this;
          this.eventsToUnbind.forEach((e) => e()), this.eventsToUnbind = [], !X.chartCount && (Ht.unbindDocumentMouseUp.forEach((e) => e.unbind()), Ht.unbindDocumentMouseUp.length = 0, Ht.unbindDocumentTouchEnd && (Ht.unbindDocumentTouchEnd = Ht.unbindDocumentTouchEnd())), clearInterval(t.tooltipTimeout), sd(t, function(e, i) {
            t[i] = void 0;
          });
        }
        ...
        getChartPosition() {
          ...
          let { container: t } = this.chart, e = rd(t);
      ...
      Ht.unbindDocumentMouseUp = [], (function(h) {
        h.compose = function(t) {
          od(td, "Core.Pointer") && xe(t, "beforeRender", function() {
      ...
      let { setLength: nd, splice: Hl } = Fs, { fireEvent: Qa, objectEach: jr, uniqueKey: Ur } = $, yn = class {
        constructor(h = {}) {
        ...
        applyRowCount(h) {
          this.rowCount = h, jr(this.columns, (t, e) => {
            t.length !== h && (this.columns[e] = nd(t, h));
          });
        }
        deleteRows(h, t = 1) {
      ...
      (function(h) {
        function t(e, i, s) {
          ...
          if (S && S.enabled !== !1 && d) {
            ...
            c.indexOf("url") === 0 && (S = ld(S, { width: m, height: m }), O = 0), r.symbol = v = x.symbol(c, d / 2 - O, M - O, 2 * O, 2 * O, ad({ context: "legend" }, S)).addClass("highcharts-point").add(b), v.isMarker = !0;
          }
        }
      ...
      let Xl = Mi, { defaultOptions: Gl } = Kt, { extend: hd, extendClass: dd, merge: cd } = $;
      (function(h) {
        function t(e, i) {
        ...
        h.seriesTypes = X.seriesTypes, h.registerSeriesType = t, h.seriesType = function(e, i, s, r, o) {
          ...
          if (i = i || "", n[e] = cd(n[i], s), delete h.seriesTypes[e], t(e, dd(h.seriesTypes[i] || re, r)), h.seriesTypes[e].prototype.type = e, o) {
            class l extends Lt {
            }
            hd(l.prototype, o), h.seriesTypes[e].prototype.pointClass = l;
          }
          return h.seriesTypes[e];
        };
      })(Ai || (Ai = {}));
      let Dt = Ai, { animObject: Yl, setAnimation: pd } = It, { defaultOptions: bn } = Kt, { registerEventOptions: ud } = hi, { svg: gd, win: md } = X, { seriesTypes: Ds } = Dt, { format: fd } = Ut, { arrayMax: tl, arrayMin: jl, clamp: Ul, correctFloat: Vl, crisp: xd, defined: Ft, destroyObjectProperties: yd, diffObjects: bd, erase: ql, error: vn, extend: Is, find: vd, fireEvent: Ct, getClosestDistance: wd, getNestedProperty: Kl, insertItem: $l, isArray: Zl, isNumber: Wt, isString: kd, merge: Vr, objectEach: el, pick: Et, removeEvent: Md, syncTimeout: _l } = $;
      class Pe {
        constructor() {
          this.zoneAxis = "y";
        }
        ...
        getName() {
          return this.options.name ?? fd(this.chart.options.lang.seriesName, this, this.chart);
        }
        getCyclic(t, e, i) {
        ...
        findPointIndex(t, e) {
          ...
          if (o) {
            ...
            if (d?.matchByName ? c = (f) => !f.touched && f.name === t.name : this.options.relativeXValue && (c = (f) => !f.touched && f.options.x === t.x), !(i = vd(l, c))) return;
          }
        ...
        setData(t, e = !0, i, s) {
          ...
          if (d?.enabled && (t = this.sortData(t)), l.options.chart.allowMutatingData && s !== !1 && D && o && !this.cropped && !this.hasGroupedData && this.visible && !this.boosted && (S = this.updateData(t, i)), !S) {
            ...
            for (kd(this.getColumn("y")[0]) && vn(14, !0, l), this.data = [], this.options.data = this.userOptions.data = t, v = o; v--; ) r[v]?.destroy();
        ...
        markerAttribs(t, e) {
          ...
          let c = t.pos();
          return Wt(m) && c && (i.crisp && (c[0] = xd(c[0], t.hasImage ? 0 : o === "rect" ? s?.lineWidth || 0 : 1)), n.x = c[0] - m, n.y = c[1] - m), m && (n.width = n.height = 2 * m), n;
        }
        pointAttribs(t, e) {
        ...
        destroy(t) {
          let e, i, s = this, r = s.chart, o = /AppleWebKit\/533/.test(md.navigator.userAgent), n = s.data || [];
          ...
          for (let l of s.zones) yd(l, void 0, !0);
          $.clearTimeout(s.animationTimeout), el(s, function(l, d) {
            l instanceof le && !l.survive && l[o && d === "group" ? "hide" : "destroy"]();
        ...
        drawTracker() {
          ...
          }, m = "rgba(192,192,192," + (gd ? 1e-4 : 2e-3) + ")", c = t.tracker;
        ...
        removePoint(t, e, i) {
          ...
          pd(i, r), e = Et(e, !0), d ? d.firePointEvent("remove", null, m) : m();
        }
        remove(t, e, i, s) {
        ...
        update(t, e) {
          Ct(this, "update", { options: t = bd(t, this.userOptions) });
      ...
      let re = Pe, { animObject: Ad, setAnimation: Td } = It, { registerEventOptions: Jl } = hi, { composed: Sd, marginNames: Ql } = X, { distribute: Cd } = ps, { format: Ed } = Ut, { addEvent: wn, createElement: Pd, css: Od, defined: il, discardElement: Ld, find: Dd, fireEvent: ti, isNumber: th, merge: Vi, pick: Oe, pushUnique: Id, relativeLength: Bd, stableSort: Nd, syncTimeout: Rd } = $;
      class sl {
        constructor(t, e) {
        ...
        colorizeItem(t, e) {
          ...
          if ((t instanceof re || t instanceof Lt) && (t.color = t.options?.legendSymbolColor || i), r?.[e ? "removeClass" : "addClass"]("highcharts-legend-item-hidden"), !this.chart.styledMode) {
        ...
        destroyItem(t) {
          ...
          t.checkbox = Ld(t.checkbox), t.legendItem = void 0;
        }
        destroy() {
        ...
        positionCheckboxes() {
          ...
          e && (t = e.translateY, this.allItems.forEach(function(r) {
            let o, n = r.checkbox;
            n && (o = t + s + n.y + (this.scrollOffset || 0) + 3, Od(n, { left: e.translateX + r.checkboxOffset + n.x - 20 + "px", top: o + "px", display: this.proximate || o > t - 6 && o < t + i - 6 ? "" : "none" }));
          }, this));
        }
        renderTitle() {
        ...
        setText(t) {
          let e = this.options;
          t.legendItem.label.attr({ text: e.labelFormat ? Ed(e.labelFormat, t, this.chart) : e.labelFormatter.call(t) });
        }
        renderItem(t) {
        ...
        proximatePositions() {
          ...
          for (let r of (this.allItems.forEach(function(o) {
            let n, l, d = s, m, c;
            o.yAxis && (o.xAxis.options.reversed && (d = !d), o.points && (n = Dd(d ? o.points : o.points.slice(0).reverse(), function(f) {
              return th(f.plotY);
        ...
        scroll(t, e) {
          ...
          m > r && (m = r), m > 0 && (e !== void 0 && Td(e, i), this.nav.attr({ translateX: d, translateY: o + this.padding + 7 + this.titleHeight, visibility: "inherit" }), [this.up, this.upTracker].forEach(function(c) {
          ...
          }, this), i.styledMode || (this.up.attr({ fill: m === 1 ? n.inactiveColor : n.activeColor }), this.upTracker.css({ cursor: m === 1 ? "default" : "pointer" }), this.down.attr({ fill: m === r ? n.inactiveColor : n.activeColor }), this.downTracker.css({ cursor: m === r ? "default" : "pointer" })), this.scrollOffset = -s[m - 1] + this.initialItemY, this.scrollGroup.animate({ translateY: this.scrollOffset }), this.currentPage = m, this.positionCheckboxes(), Rd(() => {
            ti(this, "afterScroll", { currentPage: m });
          }, Ad(Oe(e, i.renderer.globalAnimation, !0)).duration));
        }
        setItemEvents(t, e, i) {
          let s = this, r = t.legendItem || {}, o = s.chart.renderer.boxWrapper, n = t instanceof Lt, l = t instanceof re, d = "highcharts-legend-" + (n ? "point" : "series") + "-active", m = s.chart.styledMode, c = i ? [e, r.symbol] : [r.group], f = (x) => {
        ...
        createCheckboxForItem(t) {
          t.checkbox = Pd("input", { type: "checkbox", className: "highcharts-legend-checkbox", checked: t.selected, defaultChecked: t.selected }, this.options.itemCheckboxStyle, this.chart.container), wn(t.checkbox, "click", function(e) {
            let i = e.target;
      ...
      (function(h) {
        h.compose = function(t) {
          Id(Sd, "Core.Legend") && wn(t, "beforeMargins", function() {
            this.legend = new h(this, this.options.legend);
          });
        };
      })(sl || (sl = {}));
      let eh = sl, { animate: rl, animObject: zd, setAnimation: ol } = It, { defaultOptions: nl } = Kt, { numberFormat: Fd } = Ut, { registerEventOptions: ih } = hi, { charts: qi, doc: qr, marginNames: sh, svg: Hd, win: rh } = X, { seriesTypes: al } = Dt, { addEvent: ll, attr: oh, createElement: hl, css: Le, defined: fi, diffObjects: nh, discardElement: Wd, erase: Xd, error: dl, extend: xi, find: cl, fireEvent: pt, getAlignFactor: Gd, getStyle: pl, isArray: Yd, isNumber: Bs, isObject: jd, isString: kn, merge: qe, objectEach: ul, pick: $t, pInt: Ud, relativeLength: ah, removeEvent: lh, splat: Mn, syncTimeout: Vd, uniqueKey: qd } = $;
      class yi {
        static chart(t, e, i) {
          return new yi(t, e, i);
        }
        ...
        setZoomOptions() {
          ...
          this.zooming = { ...e, type: $t(t.zoomType, e.type), key: $t(t.zoomKey, e.key), pinchType: $t(t.pinchType, e.pinchType), singleTouch: $t(t.zoomBySingleTouch, e.singleTouch, !1), resetButton: qe(e.resetButton, t.resetZoomButton) };
        }
        init(t, e) {
          pt(this, "init", { args: arguments }, function() {
            let i = qe(nl, t), s = i.chart, r = this.renderTo || s.renderTo;
            this.userOptions = xi({}, t), (this.renderTo = kn(r) ? qr.getElementById(r) : r) || dl(13, !0, this), this.margin = [], this.spacing = [], this.labelCollectors = [], this.callback = e, this.isResizing = 0, this.options = i, this.axes = [], this.series = [], this.locale = i.lang.locale ?? this.renderTo.closest("[lang]")?.lang, this.time = new Ks(xi(i.time || {}, { locale: this.locale }), i.lang), i.time = this.time.options, this.numberFormatter = (s.numberFormatter || Fd).bind(this), this.styledMode = s.styledMode, this.hasCartesianSeries = s.showAxes, this.index = qi.length, qi.push(this), X.chartCount++, ih(this, s), this.xAxis = [], this.yAxis = [], this.pointCount = this.colorCounter = this.symbolCounter = 0, this.setZoomOptions(), pt(this, "afterInit"), this.firstRender();
          });
        }
        initSeries(t) {
        ...
        orderItems(t, e = 0) {
          ...
          if (this.hasRendered && (s.splice(e), r.splice(e)), i) for (let o = e, n = i.length; o < n; ++o) {
            let l = i[o];
            l && (l.index = o, l instanceof re && (l.name = l.getName()), l.options.isInternal || (s[o] = l.options, r[o] = l.userOptions));
          }
        }
        getClipBox(t, e) {
        ...
        getSelectedPoints() {
          return this.series.reduce((t, e) => (e.getPointsCollection().forEach((i) => {
            $t(i.selectedStaging, i.selected) && t.push(i);
          }), t), []);
        }
        getSelectedSeries() {
        ...
        layOutTitles(t = !0) {
          ...
          ["title", "subtitle", "caption"].forEach((n) => {
            ...
            if (l && d) {
              ...
              if (L.height = N, l.align(L, !1, m).attr({ align: L.align, scaleX: O, scaleY: O, "transform-origin": `${m.x + c * O * Gd(L.align)} ${b}` }), !d.floating) {
                let I = N * (N < 1.2 * b ? 1 : O);
        ...
        getContainer() {
          let t, e = this.options, i = e.chart, s = "data-highcharts-chart", r = qd(), o = this.renderTo, n = Ud(oh(o, s));
          ...
          this.container = m, this.getChartSize(), d !== this.chartWidth && (d = this.chartWidth, this.styledMode || Le(m, { width: $t(i.style?.width, d + "px") })), this.containerBox = this.getContainerBox(), this._cursor = m.style.cursor;
          let c = i.renderer || !Hd ? Ii.getRendererType(i.renderer) : bs;
        ...
        reflow(t) {
          ...
          delete e.pointer?.chartPosition, !e.exporting?.isPrinting && !e.isResizing && i && s.width && ((s.width !== i.width || s.height !== i.height) && ($.clearTimeout(e.reflowTimeout), e.reflowTimeout = Vd(function() {
        ...
        linkSeries(t) {
          ...
          i.forEach(function(s) {
            ...
            if (kn(r)) {
              let o;
              (o = r === ":previous" ? e.series[s.index - 1] : e.get(r)) && o.linkedParent !== s && (o.linkedSeries.push(s), s.linkedParent = o, o.enabledDataSorting && s.setDataSortingOptions(), s.visible = $t(s.options.visible, o.options.visible, s.visible));
            }
        ...
        render() {
          ...
          for (let m of (this.setTitle(), pt(this, "beforeMargins"), this.getStacks?.(), this.getMargins(!0), this.setChartSize(), t)) {
            ...
            if (this.hasCartesianSeries && m.horiz && m.visible && f.enabled && m.series.length && m.coll !== "colorAxis" && !this.polar) {
              ...
              if (x.destroy(), b && $t(f.reserveSpace, !Bs(c.crossing)) && (o = b.getBBox().height + f.distance + Math.max(c.offset || 0, 0)), o) {
                b?.destroy();
                break;
              }
            }
        ...
        destroy() {
          ...
          for (pt(e, "destroy"), e.renderer.forExport ? Xd(qi, e) : qi[e.index] = void 0, X.chartCount--, e.renderTo.removeAttribute("data-highcharts-chart"), lh(e), t = i.length; t--; ) i[t] = i[t].destroy();
          ...
          ["title", "subtitle", "chartBackground", "plotBackground", "plotBGImage", "plotBorder", "seriesGroup", "clipRect", "credits", "pointer", "rangeSelector", "legend", "resetZoomButton", "tooltip", "renderer"].forEach((n) => {
            e[n] = e[n]?.destroy?.();
          }), r && (r.innerHTML = Mt.emptyHTML, lh(r), o && Wd(r)), ul(e, function(n, l) {
            delete e[l];
          });
        }
        firstRender() {
        ...
        addSeries(t, e, i) {
          let s, r = this;
          return t && (e = $t(e, !0), pt(r, "addSeries", { options: t }, function() {
        ...
        createAxis(t, e) {
          ...
          return $t(e.redraw, !0) && this.redraw(e.animation), i;
        }
        showLoading(t) {
          ...
          o || (e.loadingDiv = o = hl("div", { className: "highcharts-loading highcharts-loading-hidden" }, null, e.container)), n || (e.loadingSpan = n = hl("span", { className: "highcharts-loading-inner" }, null, o), ll(e, "redraw", r)), o.className = "highcharts-loading", Mt.setElementHTML(n, $t(t, i.lang.loading, "")), !e.styledMode && (Le(o, xi(s.style, { zIndex: 10 })), Le(n, s.labelStyle), e.loadingShown || (Le(o, { opacity: 0, display: "" }), rl(o, { opacity: s.style.opacity || 0.5 }, { duration: s.showDuration || 0 }))), e.loadingShown = !0, r();
        }
        hideLoading() {
        ...
        update(t, e, i, s) {
          ...
          f && (qe(!0, l.options.chart, f), this.setZoomOptions(), "className" in f && l.setClassName(f.className), ("inverted" in f || "polar" in f || "type" in f) && (l.propFromSeries(), r = !0), "alignTicks" in f && (r = !0), "events" in f && ih(this, f), ul(f, function(M, k) {
            ...
            t[M] && (Mn(t[M]).forEach(function(k, v) {
              let S, C = fi(k.id);
              C && (S = l.get(k.id)), !S && l[M] && (S = l[M][$t(k.index, v)]) && (C && fi(S.options.id) || S.options.isInternal) && (S = void 0), S && S.coll === M && (S.update(k, !1), i && (S.touched = !0)), !S && i && l.collectionsWithInit[M] && (l.collectionsWithInit[M][0].apply(l, [k].concat(l.collectionsWithInit[M][1] || []).concat([!1])).touched = !0);
          ...
          n || Bs(x) && x !== l.chartWidth || Bs(b) && b !== l.chartHeight ? l.setSize(x, b, s) : $t(e, !0) && l.redraw(s), pt(l, "afterUpdate", { options: t, redraw: e, animation: s });
        }
        setSubtitle(t, e) {
        ...
        transform(t) {
          ...
          for (let b of e) {
            let { horiz: M, len: k, minPointOffset: v = 0, options: S, reversed: C } = b, O = M ? "width" : "height", L = M ? "x" : "y", D = $t(n[O], b.len), N = $t(s[O], b.len), I = 10 > Math.abs(D) ? 1 : D / N, W = (s[L] || 0) + N / 2 - b.pos, Y = W - ((n[L] ?? b.pos) + D / 2 - b.pos) / I, H = C && !d || !C && d ? -1 : 1;
            ...
            if (o && o[b.coll].push({ axis: b, min: Math.min(Z, J), max: Math.max(Z, J) }), j > q && ([j, q] = [q, j]), I === 1 && !r && b.coll === "yAxis" && !_) {
              for (let Jt of b.series) {
                let Ke = Jt.getExtremes(Jt.getProcessedData(!0).modified.getColumn("y") || [], !0);
            ...
            let { dataMin: vt, dataMax: ht, min: Zt, max: st } = xi(b.getExtremes(), _ || {}), it = m.parse(S.min), ut = m.parse(S.max), at = vt ?? it, wt = ht ?? ut, kt = q - j, mt = b.categories ? 0 : Math.min(kt, wt - at), Pt = at - mt * (fi(it) ? 0 : S.minPadding), _t = wt + mt * (fi(ut) ? 0 : S.maxPadding), oe = b.allowZoomOutside || I === 1 || l !== "zoom" && I > 1, wi = Math.min(it ?? Pt, Pt, oe ? Zt : Pt), De = Math.max(ut ?? _t, _t, oe ? st : _t);
            (!b.isOrdinal || I !== 1 || r) && (j < wi && (j = wi, I >= 1 && (q = j + kt)), q > De && (q = De, I >= 1 && (j = q - kt)), (r || b.series.length && (j !== Zt || q !== st) && j >= wi && q <= De) && (o ? o[b.coll].push({ axis: b, min: j, max: q }) : (b.isPanning = l !== "zoom", b.isPanning && (x = !0), b.setExtremes(r ? void 0 : j, r ? void 0 : q, !1, !1, { move: Y, trigger: l, scale: I }), !r && (j > wi || q < De) && l !== "mousewheel" && (f = !0)), c = !0), this.hasCartesianSeries || r || l === "mousewheel" || (f = !0), i && (this[M ? "mouseDownX" : "mouseDownY"] = i[M ? "chartX" : "chartY"]));
          }
      ...
      let { stop: Kd } = It, { composed: $d } = X, { addEvent: bi, createElement: An, css: gl, defined: ml, erase: Zd, merge: hh, pushUnique: dh } = $;
      function _d() {
      ...
      class Kr {
        static compose(t, e, i) {
          dh($d, this.compose) && (bi(t, "afterInit", ch), bi(e, "afterSetChartSize", (s) => this.afterSetSize(s.target, s)), bi(e, "render", _d), bi(i, "show", ch));
        }
        ...
        applyFixed() {
          ...
          e.setSize(o, n), (i ?? !0) && (this.isDirty = !1, this.moveFixedElements()), Kd(t.container), gl(l, { width: `${v}px`, height: `${S}px` }), t.renderer.boxWrapper.attr({ width: v, height: S, viewBox: [0, 0, v, S].join(" ") }), t.chartBackground?.attr({ width: v, height: S }), gl(s, { width: `${o}px`, height: `${n}px` }), ml(i) || (s.scrollLeft = x * M, s.scrollTop = b * k);
        ...
        moveFixedElements() {
          ...
          else for (let l of [".highcharts-xaxis", ".highcharts-yaxis"]) for (let d of [`${l}:not(.highcharts-radial-axis)`, `${l}-labels:not(.highcharts-radial-axis-labels)`]) Zd(n, d);
      ...
      let { format: Jd } = Ut, { series: Qd } = Dt, { destroyObjectProperties: tc, fireEvent: ph, getAlignFactor: fl, isNumber: xl, pick: $r } = $, uh = class {
        constructor(h, t, e, i, s) {
        ...
        render(h) {
          let t = this.axis.chart, e = this.options, i = e.format, s = i ? Jd(i, this, t) : e.formatter.call(this);
        ...
        setOffset(h, t, e, i, s, r) {
          ...
          if (l && f) {
            ...
            f.x -= S, f.y -= C, l.align(o, !1, f), (v = c.isInsidePlot(l.alignAttr.x + o.x + S, l.alignAttr.y + o.y + C)) || (k = !1), k && Qd.prototype.justifyDataLabel.call(n, l, o, l.alignAttr, b, f), l.attr({ x: l.alignAttr.x, y: l.alignAttr.y, rotation: d.rotation, rotationOriginX: b.width * fl(d.textAlign || "center"), rotationOriginY: b.height / 2 }), $r(!k && d.crop, !0) && (v = xl(l.x) && xl(l.y) && c.isInsidePlot(l.x - M + (l.width || 0), l.y) && c.isInsidePlot(l.x + M, l.y)), l[v ? "show" : "hide"]();
          }
      ...
      }, { getDeferredAnimation: ec } = It, { series: { prototype: ic } } = Dt, { addEvent: gh, correctFloat: Zr, defined: mh, destroyObjectProperties: sc, fireEvent: rc, isNumber: yl, objectEach: Ki, pick: bl } = $;
      function oc() {
        let h = this.inverted;
        this.axes.forEach((t) => {
      ...
      function ac() {
        this.stacking || (this.stacking = new uc(this));
      }
      function lc(h, t, e, i) {
      ...
      function cc(h) {
        (this.is("column") || this.is("columnrange")) && (this.options.centerInCategory && this.chart.series.length > 1 ? ic.setStackedPoints.call(this, h, "group") : h.stacking.resetStacks());
      }
      function pc(h, t) {
      ...
      class uc {
        ...
        renderStackTotals() {
          let t = this.axis, e = t.chart, i = e.renderer, s = this.stacks, r = ec(e, t.options.stackLabels?.animation || !1), o = this.stackTotalGroup = this.stackTotalGroup || i.g("stack-labels").attr({ zIndex: 6, opacity: 0 }).add();
      ...
      (Ti || (Ti = {})).compose = function(h, t, e) {
        ...
        i.getStacks || (gh(h, "init", ac), gh(h, "destroy", nc), i.getStacks = oc, s.getStackIndicator = lc, s.modifyStacks = hc, s.percentStacker = dc, s.setGroupedPoints = cc, s.setStackedPoints = pc);
      };
      let gc = Ti, { defined: mc, merge: fh, isObject: fc } = $;
      class xh extends re {
        drawGraph() {
        ...
        getGraphPath(t, e, i) {
          ...
          return m && t.reverse(), (d = { right: 1, center: 2 }[d] || d && 3) && m && (d = 4 - d), (t = this.getValidPoints(t, !1, r.nullInteraction || !(r.connectNulls && !e && !i))).forEach(function(c, f) {
            ...
            (c.leftCliff || k?.rightCliff) && !i && (l = !0), v && !mc(e) && f > 0 ? l = !r.connectNulls : v && !e ? l = !0 : (f === 0 || l ? x = [["M", c.plotX, c.plotY]] : s.getPointSpline ? x = [s.getPointSpline(t, c, f)] : d ? (x = d === 1 ? [["L", k.plotX, M]] : d === 2 ? [["L", (k.plotX + b) / 2, k.plotY], ["L", (k.plotX + b) / 2, M]] : [["L", b, k.plotY]]).push(["L", b, M]) : x = [["L", b, M]], n.push(c.x), d && (n.push(c.x), d === 2 && n.push(c.x)), o.push.apply(o, x), l = !1);
          }), o.xMap = n, s.graphPath = o, o;
        }
      }
      xh.defaultOptions = fh(re.defaultOptions, { legendSymbol: "lineMarker" }), Dt.registerSeriesType("line", xh);
      let { seriesTypes: { line: vl } } = Dt, { extend: xc, merge: yc, objectEach: bc, pick: Tn } = $;
      class wl extends vl {
        drawGraph() {
      ...
      wl.defaultOptions = yc(vl.defaultOptions, { threshold: 0, legendSymbol: "areaMarker" }), xc(wl.prototype, { singleStacks: !1 }), Dt.registerSeriesType("area", wl);
      let { line: yh } = Dt.seriesTypes, { merge: vc, pick: Sn } = $;
      class kl extends yh {
      ...
      kl.defaultOptions = vc(yh.defaultOptions), Dt.registerSeriesType("spline", kl);
      let bh = kl, { area: wc, area: { prototype: Ml } } = Dt.seriesTypes, { extend: kc, merge: Mc } = $;
      class Al extends bh {
      }
      Al.defaultOptions = Mc(bh.defaultOptions, wc.defaultOptions), kc(Al.prototype, { getGraphPath: Ml.getGraphPath, getStackPoints: Ml.getStackPoints, drawGraph: Ml.drawGraph }), Dt.registerSeriesType("areaspline", Al);
      let { animObject: Ac } = It, { parse: Tc } = bt, { noop: Sc } = X, { clamp: Cn, crisp: En, defined: vh, extend: wh, fireEvent: kh, isArray: Mh, isNumber: Pn, merge: Tl, pick: _r, objectEach: Cc } = $;
      class On extends re {
        animate(t) {
          ...
          t && d ? (c.scaleY = 1e-3, i = Cn(r.toPixels(l.threshold || 0), o, o + r.len), m ? c.translateX = (i += n ? -Math.floor(d[0]) : Math.ceil(d[2])) - r.len : c.translateY = i += n ? Math.ceil(d[0]) : -Math.floor(d[2]), s.clipBox && s.setClip(), s.group.attr(c)) : (e = Number(s.group.attr(f)), s.group.animate({ scaleY: 1 }, wh(Ac(s.options.animation), { step: function(x, b) {
        ...
        adjustForMissingColumns(t, e, i, s) {
          if (!i.isNull && s.columnCount > 1) {
            ...
            Cc(this.xAxis.stacking?.stacks, (d) => {
        ...
        translate() {
          ...
          i.pointPadding && i.crisp && (k = Math.ceil(k)), re.prototype.translate.apply(t), t.points.forEach(function(v) {
        ...
        remove() {
          ...
          }), re.prototype.remove.apply(t, arguments);
        }
      }
      On.defaultOptions = Tl(re.defaultOptions, { borderRadius: 3, centerInCategory: !1, groupPadding: 0.2, marker: null, pointPadding: 0.1, minPointLength: 0, cropThreshold: 50, pointRange: null, states: { hover: { halo: !1, brightness: 0.1 }, select: { color: "#cccccc", borderColor: "#000000" } }, dataLabels: { align: void 0, verticalAlign: void 0, y: void 0 }, startFromThreshold: !0, stickyTracking: !1, tooltip: { distance: 6 }, threshold: 0, borderColor: "#ffffff" }), wh(On.prototype, { directTouch: !0, getSymbol: Sc, negStacks: !0, trackerGroups: ["group", "dataLabelsGroup"] }), Dt.registerSeriesType("column", On);
      let Ln = On, { getDeferredAnimation: Ec } = It, { format: Pc } = Ut, { defined: $i, extend: Ah, fireEvent: Sl, getAlignFactor: Th, isArray: vi, isString: Jr, merge: Qr, objectEach: Oc, pick: to, pInt: Lc, splat: Sh } = $;
      (function(h) {
        function t() {
        ...
        function r(m) {
          let c;
          m = m || this.points;
          let f = this, x = f.chart, b = f.options, M = x.renderer, { backgroundColor: k, plotBackgroundColor: v } = x.options.chart, S = M.getContrast(Jr(v) && v || Jr(k) && k || "#000000"), C = l(f), { animation: O, defer: L } = C[0], D = L ? Ec(x, O, f) : { defer: 0, duration: 0 };
          Sl(this, "drawDataLabels"), f.hasDataLabels?.() && (c = this.initDataLabels(D), m.forEach((N) => {
            ...
            Sh(n(C, N.dlOptions || N.options?.dataLabels)).forEach((H, V) => {
              let Z = H.enabled && (N.visible || N.dataLabelOnHidden) && (!N.isNull || N.dataLabelOnNull) && (function(wt, kt) {
                let mt = kt.filter;
                if (mt) {
                  let Pt = mt.operator, _t = wt[mt.property], oe = mt.value;
                  return Pt === ">" && _t > oe || Pt === "<" && _t < oe || Pt === ">=" && _t >= oe || Pt === "<=" && _t <= oe || Pt === "==" && _t == oe || Pt === "===" && _t === oe || Pt === "!=" && _t != oe || Pt === "!==" && _t !== oe || !1;
                }
                return !0;
              })(N, H), { backgroundColor: J, borderColor: j, distance: q, style: _ = {} } = H, vt, ht, Zt, st = {}, it = I[V], ut = !it, at;
              Z && (ht = $i(vt = to(H[N.formatPrefix + "Format"], H.format)) ? Pc(vt, N, x) : (H[N.formatPrefix + "Formatter"] || H.formatter).call(N, H), Zt = H.rotation, !x.styledMode && (_.color = to(H.color, _.color, Jr(f.color) ? f.color : void 0, "#000000"), _.color === "contrast" ? (J !== "none" && (at = J), N.contrastColor = M.getContrast(at !== "auto" && Jr(at) && at || (Jr(W) ? W : "")), _.color = at || !$i(q) && H.inside || 0 > Lc(q || 0) || b.stacking ? N.contrastColor : S) : delete N.contrastColor, b.cursor && (_.cursor = b.cursor)), st = { r: H.borderRadius || 0, rotation: Zt, padding: H.padding, zIndex: 1 }, x.styledMode || (st.fill = J === "auto" ? N.color : J, st.stroke = j === "auto" ? N.color : j, st["stroke-width"] = H.borderWidth), Oc(st, (wt, kt) => {
      ...
      let Dn = Si, { composed: Dc } = X, { series: Ch } = Dt, { merge: Ic, pushUnique: Bc } = $;
      (function(h) {
        function t(e, i, s, r, o) {
          ...
          if (f) {
            if (r = Ic(f), s.overflow !== "allow" || s.crop !== !1 || l.clip !== !1) {
        ...
        h.compose = function(e) {
          Dn.compose(Ch), Bc(Dc, "ColumnDataLabel") && (e.prototype.alignDataLabel = t);
        };
      })(Ci || (Ci = {}));
      let Nc = Ci, { extend: Rc, merge: zc } = $;
      class Cl extends Ln {
      }
      Cl.defaultOptions = zc(Ln.defaultOptions, {}), Rc(Cl.prototype, { inverted: !0 }), Dt.registerSeriesType("bar", Cl);
      let { column: Fc, line: Eh } = Dt.seriesTypes, { addEvent: Hc, extend: Wc, merge: Xc } = $;
      class In extends Eh {
        applyJitter() {
      ...
      In.defaultOptions = Xc(Eh.defaultOptions, { lineWidth: 0, findNearestPointBy: "xy", jitter: { x: 0, y: 0 }, marker: { enabled: !0 }, tooltip: { headerFormat: '<span style="color:{point.color}">●</span> <span style="font-size: 0.8em"> {series.name}</span><br/>', pointFormat: "x: <b>{point.x}</b><br/>y: <b>{point.y}</b><br/>" } }), Wc(In.prototype, { drawTracker: Fc.prototype.drawTracker, sorted: !1, requireSorting: !1, noSharedTooltip: !0, trackerGroups: ["group", "markerGroup", "dataLabelsGroup"] }), Hc(In, "afterTranslate", function() {
        this.applyJitter();
      }), Dt.registerSeriesType("scatter", In);
      let { deg2rad: Ph } = X, { fireEvent: Gc, isNumber: El, pick: Bn, relativeLength: Yc } = $;
      (function(h) {
        h.getCenter = function() {
          ...
          for (!e.angular || this instanceof re || (b[3] = 0), f = 0; f < 4; ++f) x = b[f], d = f < 2 || f === 2 && /%$/.test(x), b[f] = Yc(x, [s, r, n, b[2]][f]) + (d ? i : 0);
          return b[3] > b[2] && (b[3] = b[2]), El(l) && 2 * l < b[2] && l > 0 && (b[3] = b[2] - 2 * l), Gc(this, "afterGetCenter", { positions: b }), b;
        }, h.getStartAndEndRadians = function(t, e) {
          let i = El(t) ? t : 0, s = El(e) && e > i && e - i < 360 ? e : i + 360;
          return { start: Ph * (i + -90), end: Ph * (s + -90) };
        };
      })(Hs || (Hs = {}));
      let Oh = Hs, { setAnimation: jc } = It, { addEvent: Lh, defined: Uc, extend: Vc, isNumber: qc, pick: Kc, relativeLength: $c } = $;
      class Dh extends Lt {
        getConnectorPath(t) {
        ...
        slice(t, e, i) {
          let s = this.series;
          jc(i, s.chart), e = Kc(e, !0), this.sliced = this.options.sliced = t = Uc(t) ? t : !this.sliced, s.options.data[s.data.indexOf(this)] = this.options, this.graphic && this.graphic.animate(this.getTranslate());
        }
      }
      Vc(Dh.prototype, { connectorShapes: { fixedOffset: function(h, t, e) {
      ...
      let { getStartAndEndRadians: Zc } = Oh, { noop: Ih } = X, { clamp: _c, extend: Jc, fireEvent: Bh, merge: Pl, pick: Qc } = $;
      class Ol extends re {
        animate(t) {
          let e = this, i = e.points, s = e.startAngleRad;
          t || i.forEach(function(r) {
            let o = r.graphic, n = r.shapeArgs;
            o && n && (o.attr({ r: Qc(r.startR, e.center && e.center[3] / 2), start: s, end: s }), o.animate({ r: n.r, start: n.start, end: n.end }, e.options.animation));
          });
        }
        drawEmpty() {
        ...
        getX(t, e, i, s) {
          let r = this.center, o = this.radii ? this.radii[i.index] || 0 : r[2] / 2, n = s.dataLabelPosition, l = n?.distance || 0, d = Math.asin(_c((t - r[1]) / (o + l), -1, 1));
        ...
        translate(t) {
          ...
          let e = this.options, i = e.slicedOffset, s = Zc(e.startAngle, e.endAngle), r = this.startAngleRad = s.start, o = (this.endAngleRad = s.end) - r, n = this.points, l = e.ignoreHiddenPoint, d = n.length, m, c, f, x, b, M, k, v = 0;
      ...
      Ol.defaultOptions = Pl(re.defaultOptions, { borderRadius: 3, center: [null, null], clip: !1, colorByPoint: !0, dataLabels: { connectorPadding: 5, connectorShape: "crookedLine", crookDistance: void 0, distance: 30, enabled: !0, formatter: function() {
        return this.isNull ? void 0 : this.name;
      }, softConnector: !0, x: 0 }, fillColor: void 0, ignoreHiddenPoint: !0, inactiveOtherPoints: !0, legendType: "point", marker: null, size: null, showInLegend: !1, slicedOffset: 10, stickyTracking: !1, tooltip: { followPointer: !0 }, borderColor: "#ffffff", borderWidth: 1, lineWidth: void 0, states: { hover: { brightness: 0.1 } } }), Jc(Ol.prototype, { axisTypes: [], directTouch: !0, drawGraph: void 0, drawTracker: Ln.prototype.drawTracker, getCenter: Oh.getCenter, getSymbol: Ih, invertible: !1, isCartesian: !1, noSharedTooltip: !0, pointAttribs: Ln.prototype.pointAttribs, pointClass: Dh, requireSorting: !1, searchPoint: Ih, trackerGroups: ["group", "dataLabelsGroup"] }), Dt.registerSeriesType("pie", Ol);
      let { composed: tp, noop: ep } = X, { distribute: ip } = ps, { series: Nh } = Dt, { arrayMax: sp, clamp: Rh, defined: zh, isNumber: rp, pick: op, pushUnique: np, relativeLength: Fh } = $;
      (function(h) {
        ...
        function i() {
          ...
          o.visible && o.hasDataLabels?.() && (n.forEach((N) => {
            ...
            }), ip(Y, J = V + Z - H, J / 5)), N.forEach((j) => {
              (j.dataLabels || []).forEach((q) => {
                let _ = q.options || {}, vt = j.distributeBox, ht = q.dataLabelPosition, Zt = ht?.natural.y || 0, st = _.connectorPadding || 0, it = q.lineHeight || 21, ut = (it - q.getBBox().height) / 2, at = 0, wt = Zt, kt = "inherit";
                if (ht) {
                  if (Y && zh(vt) && ht.distance > 0 && (vt.pos === void 0 ? kt = "hidden" : (L = vt.size, wt = S.radialDistributionY(j, q))), _.justify) at = S.justify(j, q, b, x);
                    ...
                    case "plotEdges":
                      ...
                      break;
                    default:
                      at = S.radialDistributionX(o, j, wt - ut, Zt, q);
                  }
                  if (ht.attribs = { visibility: kt, align: ht.alignment }, ht.posAttribs = { x: at + (_.x || 0) + ({ left: st, right: -st }[ht.alignment] || 0), y: wt + (_.y || 0) - it / 2 }, ht.computed.x = at, ht.computed.y = wt - ut, op(_.crop, !0)) {
                    let mt;
          ...
          }), (sp(v) === 0 || this.verifyDataLabelOverflow(v)) && (this.placeDataLabels(), this.points.forEach((N) => {
            (N.dataLabels || []).forEach((I) => {
        ...
        h.compose = function(o) {
          if (Dn.compose(Nh), np(tp, "PieDataLabel")) {
            let n = o.prototype;
            n.dataLabelPositioners = t, n.alignDataLabel = ep, n.drawDataLabels = i, n.getDataLabelPosition = e, n.placeDataLabels = s, n.verifyDataLabelOverflow = r;
          }
        };
      })(_i || (_i = {}));
      let ap = _i;
      ...
      let { pointInPolygon: lp } = gt, { addEvent: hp, getAlignFactor: dp, fireEvent: Hh, objectEach: Wh, pick: cp } = $;
      function pp(h) {
        let t = h.length, e = (m, c) => !(c.x >= m.x + m.width || c.x + c.width <= m.x || c.y >= m.y + m.height || c.y + c.height <= m.y), i = (m, c) => {
          for (let f of m) if (lp({ x: f[0], y: f[1] }, c)) return !0;
          return !1;
        }, s, r, o, n, l, d = !1;
        for (let m = 0; m < t; m++) (s = h[m]) && (s.oldOpacity = s.opacity, s.newOpacity = 1, s.absoluteBox = (function(c) {
          if (c && (!c.alignAttr || c.placed)) {
            let f = c.box ? 0 : c.padding || 0, x = c.alignAttr || { x: c.attr("x"), y: c.attr("y") }, { height: b, polygon: M, width: k } = c.getBBox(), v = dp(c.alignValue) * k;
        ...
        for (let e of h.series || []) if (e.visible && e.hasDataLabels?.()) {
          let i = (s) => {
            for (let r of s) r.visible && (r.dataLabels || []).forEach((o) => {
              let n = o.options || {};
              o.labelrank = cp(n.labelrank, r.labelrank, r.shapeArgs?.height), n.allowOverlap ?? Number(n.distance) > 0 ? (o.oldOpacity = o.opacity, o.newOpacity = 1, Xh(o, h)) : t.push(o);
            });
          };
      ...
      let Gh = { compose: function(h) {
        let t = h.prototype;
        t.hideOverlappingLabels || (t.hideOverlappingLabels = pp, hp(h, "render", up));
      } }, { defaultOptions: gp } = Kt, { noop: Yh } = X, { addEvent: jh, extend: mp, isObject: Uh, merge: fp, relativeLength: Ll } = $, xp = { radius: 0, scope: "stack", where: void 0 }, Vh = Yh, qh = Yh;
      function yp(h, t, e, i, s = {}) {
      ...
      function bp() {
        if (this.options.borderRadius && !(this.chart.is3d && this.chart.is3d())) {
          let { options: h, yAxis: t } = this, e = h.stacking === "percent", i = gp.plotOptions?.[this.type]?.borderRadius, s = Dl(h.borderRadius, Uh(i) ? i : {}), r = t.options.reversed;
          for (let o of this.points) {
            ...
            if (o.shapeType === "roundedRect" && n) {
              ...
              b === "end" && (x && (c -= M), f += M), mp(n, { brBoxHeight: f, brBoxY: c, r: M });
            }
          }
        }
      }
      function Dl(h, t) {
        return Uh(h) || (h = { radius: h || 0 }), fp(xp, t, h);
      }
      function vp() {
      ...
      let { diffObjects: kp, extend: Mp, find: Ap, merge: Tp, pick: Nn, uniqueKey: Sp } = $;
      (function(h) {
        function t(i, s) {
          let r = i.condition;
          (r.callback || function() {
        ...
        function e(i, s) {
          ...
          !s && r && r.rules && r.rules.forEach((c) => {
            c._id === void 0 && (c._id = Sp()), this.matchResponsiveRule(c, n);
          }, this);
          let d = Tp(...n.map((c) => Ap(r?.rules || [], (f) => f._id === c)).map((c) => c?.chartOptions));
          d.isResponsiveOptions = !0, n = n.toString() || void 0;
          let m = o?.ruleIds;
          n !== m && (o && (this.currentResponsive = void 0, this.updatingResponsive = !0, this.update(o.undoOptions, i, !0), this.updatingResponsive = !1), n ? ((l = kp(d, this.options, !0, this.collectionsWithUpdate)).isResponsiveOptions = !0, this.currentResponsive = { ruleIds: n, mergedOptions: d, undoOptions: l }, this.updatingResponsive || this.update(d, i, !0)) : this.currentResponsive = void 0);
        }
      ...
      let Cp = Ji;
      X.AST = Mt, X.Axis = ui, X.Chart = yi, X.Color = bt, X.DataLabel = Dn, X.DataTableCore = yn, X.Fx = jt, X.HTMLElement = ie, X.Legend = eh, X.LegendSymbol = Xl, X.OverlappingDataLabels = X.OverlappingDataLabels || Gh, X.PlotLineOrBand = Qe, X.Point = Lt, X.Pointer = Fl, X.RendererRegistry = Ii, X.Series = re, X.SeriesRegistry = Dt, X.StackItem = uh, X.SVGElement = le, X.SVGRenderer = bs, X.Templating = Ut, X.Tick = ci, X.Time = Ks, X.Tooltip = w, X.animate = It.animate, X.animObject = It.animObject, X.chart = yi.chart, X.color = bt.parse, X.dateFormat = Ut.dateFormat, X.defaultOptions = Kt.defaultOptions, X.distribute = ps.distribute, X.format = Ut.format, X.getDeferredAnimation = It.getDeferredAnimation, X.getOptions = Kt.getOptions, X.numberFormat = Ut.numberFormat, X.seriesType = Dt.seriesType, X.setAnimation = It.setAnimation, X.setOptions = Kt.setOptions, X.stop = It.stop, X.time = Kt.defaultTime, X.timers = jt.timers, { compose: function(h, t, e) {
        let i = h.types.pie;
        if (!t.symbolCustomAttribs.includes("borderRadius")) {
          let s = e.prototype.symbols;
          jh(h, "afterColumnTranslate", bp, { order: 9 }), jh(i, "afterTranslate", vp), t.symbolCustomAttribs.push("borderRadius", "brBoxHeight", "brBoxY", "brEnd", "brStart"), Vh = s.arc, qh = s.roundedRect, s.arc = yp, s.roundedRect = wp;
        }
      }, optionsToObject: Dl }.compose(X.Series, X.SVGElement, X.SVGRenderer), Nc.compose(X.Series.types.column), Dn.compose(X.Series), Ga.compose(X.Axis), ie.compose(X.SVGRenderer), eh.compose(X.Chart), Cs.compose(X.Axis), Gh.compose(X.Chart), ap.compose(X.Series.types.pie), Qe.compose(X.Chart, X.Axis), Fl.compose(X.Chart), Cp.compose(X.Chart), Kr.compose(X.Axis, X.Chart, X.Series), gc.compose(X.Axis, X.Chart, X.Series), w.compose(X.Pointer), $.extend(X, $);
      let Ep = X;
      return K.default;
    })());
  })(Rn)), Rn.exports;
...
var Dp = Lp();
const Il = /* @__PURE__ */ Pp(Dp);
var zn = { exports: {} }, Ip = zn.exports, Zh;
function Bp() {
  return Zh || (Zh = 1, (function(Be, Xt) {
    /**
    * Highcharts JS v12.4.0 (2025-09-04)
    ...
    */
    (function(dt, qt) {
      Be.exports = qt(dt._Highcharts, dt._Highcharts.Templating, dt._Highcharts.AST, dt._Highcharts.Legend, dt._Highcharts.Axis, dt._Highcharts.Color, dt._Highcharts.SeriesRegistry, dt._Highcharts.RendererRegistry, dt._Highcharts.SVGRenderer, dt._Highcharts.Point, dt._Highcharts.Series);
    })(typeof window > "u" ? Ip : window, (dt, qt, ye, Qt, de, ne, te, Ne, Rs, zs, Fs) => (() => {
      let Mi;
      ...
      let { doc: X, win: ae } = K(), { css: Qi } = K(), Re = ae.EventTarget && new ae.EventTarget() || "none";
      function ei(u) {
        if (typeof ae.MouseEvent == "function") return new ae.MouseEvent(u.type, u);
        if (X?.createEvent) {
          let a = X.createEvent("MouseEvent");
          if (a.initMouseEvent) return a.initMouseEvent(u.type, u.bubbles, u.cancelable, u.view || ae, u.detail, u.screenX, u.screenY, u.clientX, u.clientY, u.ctrlKey, u.altKey, u.shiftKey, u.metaKey, u.button, u.relatedTarget), a;
        }
        return Ws(u.type);
      }
      function Ws(u, a, p) {
        let g = a || { x: 0, y: 0 };
        if (typeof ae.MouseEvent == "function") return new ae.MouseEvent(u, { bubbles: !0, cancelable: !0, composed: !0, button: 0, buttons: 1, relatedTarget: p || Re, view: ae, detail: +(u === "click"), screenX: g.x, screenY: g.y, clientX: g.x, clientY: g.y });
        if (X?.createEvent) {
          let y = X.createEvent("MouseEvent");
          if (y.initMouseEvent) return y.initMouseEvent(u, !0, !0, ae, +(u === "click"), g.x, g.y, g.x, g.y, !1, !1, !1, !1, 0, null), y;
        }
        return { type: u };
      }
      let Ot = { addClass: function(u, a) {
        ...
        if (typeof ae.TouchEvent == "function") {
          let g = new ae.TouchEvent(u.type, { touches: a(u.touches), targetTouches: a(u.targetTouches), changedTouches: a(u.changedTouches), ctrlKey: u.ctrlKey, shiftKey: u.shiftKey, altKey: u.altKey, metaKey: u.metaKey, bubbles: u.bubbles, cancelable: u.cancelable, composed: u.composed, detail: u.detail, view: u.view });
      ...
      let Gt = { fireEventOnWrappedOrUnwrappedElement: function u(a, p) {
      ...
      }, { fireEventOnWrappedOrUnwrappedElement: Hn } = Gt, { getFakeMouseEvent: rs } = Ot, ce = class {
        destroy() {
        }
      ...
      }, { unhideChartElementFromAT: ro, getChartTitle: si } = Gt, { doc: Oi } = K(), { stripHTMLTagsFromString: oo } = Ot, Wn = class extends ce {
        onChartUpdate() {
        ...
        getKeyboardNavigation() {
          let u = this.chart;
          return new ee(u, { keyCodeMap: [], validate: function() {
            return !0;
          }, init: function() {
      ...
      let Kt = { getAnnotationsInfoHTML: function(u) {
        let a = u.annotations;
      ...
      } }, { getAnnotationsInfoHTML: Vn } = Kt, { getAxisDescription: Li, getAxisRangeDescription: qn, getChartTitle: os, unhideChartElementFromAT: Yt } = Gt, { format: co } = be(), { doc: po } = K(), { addClass: ns, getElement: bt, getHeadingTagNameForElement: uo, stripHTMLTagsFromString: go, visuallyHideElement: Zs } = Ot, { attr: mo, pick: jt, replaceNested: Kn } = K();
      function fo(u) {
      ...
      let $n = class extends ce {
        ...
        updateScreenReaderSection(u) {
          ...
          g ? (this.setScreenReaderSectionAttribs(y, u), qs().setElementHTML(A, g), y.appendChild(A), p.insertIntoDOM(y, a), a.styledMode ? ns(A, "highcharts-visually-hidden") : Zs(A), Yt(a, A), p.afterInserted && p.afterInserted()) : (y.parentNode && y.parentNode.removeChild(y), p.element = null);
        }
        ...
        getAxesDescription() {
          let u = this.chart, a = function(T, E) {
            let P = u[T];
            return P.length > 1 || P[0] && jt(P[0].options.accessibility && P[0].options.accessibility.enabled, E);
      ...
      }, { attr: Zn } = K(), { getChartTitle: _s, unhideChartElementFromAT: xo } = Gt, { getFakeMouseEvent: as } = Ot;
      function ls(u) {
      ...
      class Di extends ce {
        ...
        getKeyboardNavigation() {
          ...
          return new ee(p, { keyCodeMap: [[[a.left, a.up], function() {
      ...
      let { animObject: ir } = K(), { doc: ds } = K(), { addEvent: ea, fireEvent: Mt, isNumber: vo, pick: wo, syncTimeout: ia } = K(), { getChartTitle: sa } = Gt, { stripHTMLTagsFromString: ko, addClass: ra, removeClass: Mo } = Ot;
      function sr(u) {
      ...
      class or extends ce {
        ...
        getKeyboardNavigation() {
          ...
          return new ee(g, { keyCodeMap: [[[a.left, a.right, a.up, a.down], function(y) {
      ...
      let { isTouchDevice: ar } = K(), { addEvent: Ae, merge: lr, pick: Ut } = K(), Ii = [];
      function oa() {
      ...
      function na() {
        ...
        if (y) {
          ...
          this.inverted ? (y.left = y.opposite ? this.chartWidth - A - y.height : this.spacing[3] + A, y.top = this.plotTop + w) : (y.left = Ut(a.left, this.plotLeft + w), y.top = y.navigatorOptions.top || this.chartHeight - y.height - A - (this.scrollbar?.options.margin || 0) - this.spacing[2] - (this.rangeSelector && this.extraBottomMargin ? this.rangeSelector.getHeight() : 0) - (u && u.verticalAlign === "bottom" && u.layout !== "proximate" && u.enabled && !u.floating ? g.legendHeight + Ut(u.margin, 10) : 0) - (this.titleOffset ? this.titleOffset[2] : 0)), a && p && (this.inverted ? a.options.left = p.options.left = y.left : a.options.top = p.options.top = y.top, a.setAxisSize(), p.setAxisSize());
        }
      }
      function aa(u) {
        !this.navigator && !this.scroller && (this.options.navigator.enabled || this.options.scrollbar.enabled) && (this.scroller = this.navigator = new Mi(this), Ut(u.redraw, !0) && this.redraw(u.animation));
      }
      function hr() {
        let u = this.options;
      ...
      } }, { addEvent: Bt, extend: le, pushUnique: Bo } = K();
      function xa() {
        this.chart.navigator && !this.options.isInternal && this.chart.navigator.setBaseSeries(null, !1);
      }
      let No = { compose: function(u, a, p) {
        cr.compose(a), Bo(ma, "Navigator") && (u.prototype.setFixedRange = Io, le(fa().prototype.symbols, gr), le(ga, { navigator: ur }), Bt(p, "afterUpdate", xa));
      ...
      let { defaultOptions: yr } = K(), { isTouchDevice: Xo } = K(), { prototype: { symbols: _e } } = ka(), { addEvent: Rt, clamp: br, correctFloat: ms, defined: ai, destroyObjectProperties: Ma, erase: Ge, extend: vr, find: fs, fireEvent: li, isArray: Go, isNumber: he, merge: Se, pick: Nt, removeEvent: xs, splat: Ye } = K();
      function ys(u, ...a) {
        let p = [].filter.call(a, he);
      ...
      class ue {
        ...
        render(a, p, g, y) {
          ...
          if (this.isDirty && this.renderElements(), a = ms(a - T / 2), p = ms(p + T / 2), !he(a) || !he(p)) if (B) g = 0, y = Nt(w.width, E.width);
          else return;
          this.left = Nt(w.left, A.plotLeft + G + (z ? A.plotWidth : 0));
          let et = this.size = lt = Nt(w.len, (z ? A.plotHeight : A.plotWidth) - 2 * G);
          U = z ? rt : lt + 2 * G, g = Nt(g, w.toPixels(a, !0)), y = Nt(y, w.toPixels(p, !0)), he(g) && Math.abs(g) !== 1 / 0 || (g = 0, y = U);
        ...
        init(a) {
          ...
          if (a.options.scrollbar?.enabled) {
            ...
            he(U.margin) || (U.margin = a.inverted ? -3 : 3), a.scrollbar = B.scrollbar = new Xe(a.renderer, U, a), Rt(B.scrollbar, "changed", function(ct) {
        ...
        modifyBaseAxisExtremes() {
          ...
          !(this.eventArgs && this.eventArgs.trigger === "rangeSelectorButton") && (B && (a = (p = T) + P), z && (a = E + R, B || (p = Math.max(T, a - P, g.getBaseSeriesMin(F && F.xData ? F.xData[0] : -Number.MAX_VALUE)))), G && (B || z) && he(p) && (this.min = this.userMin = p, this.max = this.userMax = a)), g.stickToMin = g.stickToMax = null;
        }
        updatedDataHandler() {
        ...
        shouldStickToMin(a, p) {
          ...
          return !!(he(A) && he(w)) && (T && A - g > 0 ? A - g < T : w <= g);
        }
        addChartEvents() {
      ...
      let { animObject: Wi } = K(), { format: wr } = be(), { clamp: kr, pick: Mr, syncTimeout: Aa } = K(), { getFakeMouseEvent: Ta } = Ot, { getAxisRangeDescription: Sa, fireEventOnWrappedOrUnwrappedElement: bs } = Gt, Ca = class extends ce {
        init() {
          let u = this.chart, a = this;
        ...
        getNavigatorHandleNavigation(u) {
          ...
          return new ee(p, { keyCodeMap: [[[y.left, y.right, y.up, y.down], function(A) {
            if (g) {
      ...
      }, { getPointAnnotationTexts: Ea } = Kt, { getAxisDescription: Pa, getSeriesFirstPointElement: je, getSeriesA11yElement: Oa, unhideChartElementFromAT: Yo } = Gt, { format: vs, numberFormat: La } = be(), { reverseChildNodes: ws, stripHTMLTagsFromString: jo } = Ot, { find: Da, isNumber: Uo, isString: Vo, pick: ie, defined: ge } = K();
      function qo(u) {
      ...
      function Zo(u) {
        let a = u.series, p = a.chart.series.length > 1 || a.options.name, g = (function(T) {
          let E = T.series, P = E.chart, B = E.options.accessibility, z = B && B.point && B.point.valueDescriptionFormat || P.options.accessibility.point.valueDescriptionFormat, R = ie(E.xAxis && E.xAxis.options.accessibility && E.xAxis.options.accessibility.enabled, !P.angular && E.type !== "flowmap"), F = R ? (function(G) {
            let U = (function(lt) {
          ...
          return vs(z, { point: T, index: ge(T.index) ? T.index + 1 : "", xDescription: F, value: (function(G) {
            ...
            if (U.pointArrayMap) {
              let xt = lt || "", zt = tt || "", St = function(Lt) {
                let Ee = Ko(G, ie(G[Lt], G.options[Lt]));
      ...
      function _o(u) {
        ...
        return vs(ie(u.options.accessibility && u.options.accessibility.descriptionFormat, a.options.accessibility.series.descriptionFormat, ""), { seriesDescription: B, authorDescription: g ? " " + g : "", axisDescription: z, series: u, chart: a, seriesNumber: A }, void 0);
      }
        ...
        if (g) {
          ...
          if ((A || w) && u.points.forEach((E) => {
            let P = E.graphic && E.graphic.element || (function(z) {
              ...
              })(z), G = F && F.graphic, U = G ? G.parentGroup : R.graph || R.group, ct = F ? { x: ie(z.plotX, F.plotX, 0), y: ie(z.plotY, F.plotY, 0) } : { x: ie(z.plotX, 0), y: ie(z.plotY, 0) }, nt = (function(rt, lt) {
      ...
      } }, { composed: Ar } = K(), { addEvent: Jo, defined: Xi, pushUnique: Tr } = K(), { getChartTitle: Ia } = Gt, { defaultPointDescriptionFormatter: Qo, defaultSeriesDescriptionFormatter: Gi } = hi;
      function Sr(u) {
      ...
      let Cr = di, { doc: Er, win: me } = K(), { attr: ci, css: tn, merge: en } = K(), { fireEventOnWrappedOrUnwrappedElement: sn } = Gt, { cloneMouseEvent: Pr, cloneTouchEvent: Ba, getFakeMouseEvent: Na, removeElement: rn } = Ot, Ra = class {
      ...
      }, { doc: Or } = K(), { attr: Vt, css: yt } = K(), { unhideChartElementFromAT: on } = Gt, { removeChildNodes: Lr } = Ot, Dr = class {
        constructor(u) {
        ...
        addGroup(u, a = "div", p) {
          ...
          return p && p.role && a !== "div" ? (g = this.domElementProvider.createElement("div")).appendChild(A) : g = A, g.className = "highcharts-a11y-proxy-group highcharts-a11y-proxy-group-" + u.replace(/\W/g, "-"), this.groups[u] = { proxyContainerElement: A, groupElement: g, type: a, proxyElements: [] }, Vt(g, p || {}), a === "ul" && A.setAttribute("role", "list"), this.afterChartProxyPosContainer.appendChild(g), this.updateGroupOrder(this.groupOrder), g;
        }
      ...
      }, { unhideChartElementFromAT: pi, getAxisRangeDescription: Tt } = Gt, { addEvent: Yi, attr: nn } = K();
      class ks extends ce {
        init() {
          let a = this.chart;
        ...
        getRangeSelectorButtonNavigation() {
          ...
          return new ee(a, { keyCodeMap: [[[p.left, p.right, p.up, p.down], function(y) {
        ...
        getRangeSelectorInputNavigation() {
          let a = this.chart, p = this;
          return new ee(a, { keyCodeMap: [], validate: function() {
      ...
      let { seriesTypes: Ir } = Lo(), { doc: ui } = K(), { defined: Ce, fireEvent: Wa } = K(), { getPointFromXY: Xa, getSeriesFromName: Ss, scrollAxisToPoint: Ga } = Gt;
      function Br(u) {
      ...
      class Es {
        ...
        getKeyboardNavigationHandler() {
          ...
          return new ee(g, { keyCodeMap: [[y ? [p.up, p.down] : [p.left, p.right], function(A) {
      ...
      let hn = Es, { hideSeriesFromAT: Ya } = Gt, { describeSeries: dn } = hi, Rr = class extends ce {
      ...
      }, { unhideChartElementFromAT: fe } = Gt, { getFakeMouseEvent: zr } = Ot, { attr: ja, pick: Ua } = K(), cn = class extends ce {
        constructor() {
        ...
        getMapZoomNavigation() {
          ...
          return new ee(a, { keyCodeMap: [[[u.up, u.down, u.left, u.right], function(g) {
        ...
        simpleButtonNavigation(u, a, p) {
          ...
          return new ee(A, { keyCodeMap: [[[g.tab, g.up, g.down, g.left, g.right], function(w, T) {
      ...
      let mn = Gr, se = K();
      se.i18nFormat = mn.i18nFormat, se.A11yChartUtilities = Gt, se.A11yHTMLUtilities = Ot, se.AccessibilityComponent = ce, se.KeyboardNavigationHandler = ee, se.SeriesAccessibilityDescriber = hi, mn.compose(se.Chart, se.Legend, se.Point, se.Series, se.SVGElement, se.RangeSelector);
      let Yr = K();
      return Ji.default;
    })());
  })(zn)), zn.exports;
...
class Np {
  ...
  async renderCartesianChart(Xt, dt, qt, ye) {
    const Qt = [];
    for (const te of dt.data.measures)
      Qt.push({ type: Xt.options.highchartsType, name: te.name, data: te.data });
    const de = {
    ...
    }, ne = Il.chart(qt, de, ye);
    return { chart: ne, resize: () => ne.reflow(), vendorId: Bl };
  }
  // Operations - Render polar chart.
  async renderPolarChart(Xt, dt, qt, ye) {
  ...
  async renderRangeChart(Xt, dt, qt, ye) {
    ...
    const ne = {
      ...
      xAxis: { categories: dt.data.categoryLabels },
      yAxis: { title: { text: dt.data.name } }
    }, te = Il.chart(qt, ne, ye);
    return { chart: te, resize: () => te.reflow(), vendorId: Bl };
  }
  // Utilities - Load dependency wheel and sankey modules.
  async loadDependencyWheelAndSankeyModules() {
    _h || (await Promise.all([import("./dependency-wheel-CD07FDdB.js").then((Xt) => Xt.d), import("./sankey-DZ_z3e51.js").then((Xt) => Xt.s)]), _h = !0);
  }
  // Utilities - Load Highcharts more.
  async loadHighchartsMore() {
    Jh || (await import("./highcharts-more-DGRrl1r3.js").then((Xt) => Xt.h), Jh = !0);
  }
  // Utilities - Load streamgraph module.
  async loadStreamgraphModule() {
    Qh || (await import("./streamgraph-B3O7m-_M.js").then((Xt) => Xt.s), Qh = !0);
  }
}
export {
  Np as H,
